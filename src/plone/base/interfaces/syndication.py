...
class ISiteSyndicationSettings(Interface):
    ...
    default_enabled = schema.Bool(
        ...
        description=_(
            "If syndication should be enabled by default for all "
    ...
    max_items = schema.Int(
        title=_("label_syndication_max_items", default="Maximum items"),
        description=_(
    ...
    site_rss_items = schema.Tuple(
        title=_("Site RSS"),
        description=_(
            "Paths to folders and collections to link to " "at the portal root."
        ),
        required=False,
